module fyooz.c.fuse.fuse_lowlevel;
/*
...
public import fyooz.c.fuse.fuse_common;
...
extern (System) nothrow __gshared
{
    ...
    /** Inode number type */
    alias fuse_ino_t = c_ulong;

    alias stat_t stat_;
    alias statvfs_t statvfs_;
    alias flock flock_;
    ...
    enum FUSE_SET_ATTR_MODE = 1 << 0;
    enum FUSE_SET_ATTR_UID = 1 << 1;
    enum FUSE_SET_ATTR_GID = 1 << 2;
    enum FUSE_SET_ATTR_SIZE = 1 << 3;
    enum FUSE_SET_ATTR_ATIME = 1 << 4;
    enum FUSE_SET_ATTR_MTIME = 1 << 5;
    enum FUSE_SET_ATTR_ATIME_NOW = 1 << 7;
    enum FUSE_SET_ATTR_MTIME_NOW = 1 << 8;
    enum FUSE_SET_ATTR_CRTIME = 1 << 28;
    enum FUSE_SET_ATTR_CHGTIME = 1 << 29;
    enum FUSE_SET_ATTR_BKUPTIME = 1 << 30;
    enum FUSE_SET_ATTR_FLAGS = 1 << 31;
    /* __APPLE__ */
    ...
    struct fuse_lowlevel_ops
    {
        ...
        /**
	    	 ...
	    	 */
        void function(fuse_req_t req, fuse_ino_t parent, const(char)* name) lookup;
        ...
        /**
	    	 ...
	    	 */
        void function(fuse_req_t req, fuse_ino_t ino, stat_* attr, int to_set, fuse_file_info* fi) setattr;
        ...
        /**
	    	 ...
	    	 */
        void function(fuse_req_t req, fuse_ino_t parent, const(char)* name, mode_t mode, dev_t rdev) mknod;
        ...
        /**
	    	 ...
	    	 */
        void function(fuse_req_t req, fuse_ino_t parent, const(char)* name, mode_t mode) mkdir;
        ...
        /**
	    	 ...
	    	 */
        void function(fuse_req_t req, fuse_ino_t parent, const(char)* name) unlink;
        ...
        /**
	    	 ...
	    	 * @param name to remove
	    	 */
        void function(fuse_req_t req, fuse_ino_t parent, const(char)* name) rmdir;
        ...
        /**
	    	 ...
	    	 * @param name to create
	    	 */
        void function(fuse_req_t req, const(char)* link, fuse_ino_t parent, const(char)* name) symlink;
        ...
        /** Rename a file
	    	 ...
	    	 */
        void function(fuse_req_t req, fuse_ino_t parent, const(char)* name,
                fuse_ino_t newparent, const(char)* newname) rename;
        ...
        /**
	    	 ...
	    	 */
        void function(fuse_req_t req, fuse_ino_t ino, fuse_ino_t newparent, const(char)* newname) link;
        ...
        /**
	    	 ...
	    	 * @param fi file information
	    	 */
        void function(fuse_req_t req, fuse_ino_t ino, const(char)* buf,
                size_t size, off_t off, fuse_file_info* fi) write;
        ...
        void function(fuse_req_t req, fuse_ino_t ino, const(char)* name,
                const(char)* value, size_t size, int flags, uint position) setxattr;
        ...
        void function(fuse_req_t req, fuse_ino_t ino, const(char)* name, size_t size, uint position) getxattr;
        ...
        /**
	    	 ...
	    	 * @param name of the extended attribute
	    	 */
        void function(fuse_req_t req, fuse_ino_t ino, const(char)* name) removexattr;
        ...
        /**
	    	 ...
	    	 */
        void function(fuse_req_t req, fuse_ino_t parent, const(char)* name,
                mode_t mode, fuse_file_info* fi) create;
        ...
        /**
	    	 ...
	    	 */
        void function(fuse_req_t req, fuse_ino_t ino, fuse_file_info* fi, flock_* lock) getlk;
        ...
        /**
	    	 ...
	    	 */
        void function(fuse_req_t req, fuse_ino_t ino, fuse_file_info* fi, flock_* lock, int sleep) setlk;
        ...
        /**
	    	 ...
	    	 */
        void function(fuse_req_t req, fuse_ino_t ino, int cmd, void* arg,
                fuse_file_info* fi, uint flags, const(void)* in_buf,
                size_t in_bufsz, size_t out_bufsz) ioctl;
         ...
         * bytes read from bufv->buf[0]).
	    	 ...
	    	 * @param fi file information
	    	 */
        void function(fuse_req_t req, fuse_ino_t ino, fuse_bufvec* bufv,
                off_t off, fuse_file_info* fi) write_buf;
        ...
        /**
	    	 ...
	    	 *             see fallocate(2)
	    	 */
        void function(fuse_req_t req, fuse_ino_t ino, int mode, off_t offset,
                off_t length, fuse_file_info* fi) fallocate;

        void function(fuse_req_t req, fuse_ino_t ino, void*, void*, void*,
                void*, void*, void*) reserved00;
        void function(fuse_req_t req, fuse_ino_t ino, void*, void*, void*,
                void*, void*, void*) reserved01;
        void function(fuse_req_t req, fuse_ino_t ino, void*, void*, void*,
                void*, void*, void*) reserved02;
        void function(fuse_req_t req, fuse_ino_t ino, void*, void*, void*,
                void*, void*, void*) reserved03;

        void function(fuse_req_t req, const(char)* name) setvolname;

        void function(fuse_req_t req, fuse_ino_t parent, const(char)* name,
                fuse_ino_t newparent, const(char)* newname, c_ulong options) exchange;

        void function(fuse_req_t req, fuse_ino_t ino, fuse_file_info*) getxtimes;

        void function(fuse_req_t req, fuse_ino_t ino, void* attr, int to_set, fuse_file_info* fi) setattr_x;
    ...
    int fuse_reply_xtimes(fuse_req_t req, const(timespec)* bkuptime, const(timespec)* crtime);
	 ...
	 * @return zero for success, -errno for failure to send reply
	 */
    int fuse_reply_attr(fuse_req_t req, const(stat_)* attr, double attr_timeout);
	 ...
	 * @return zero for success, -errno for failure to send reply
	 */
    int fuse_reply_statfs(fuse_req_t req, const(statvfs_)* stbuf);
	 ...
	 * @return zero for success, -errno for failure to send reply
	 */
    int fuse_reply_lock(fuse_req_t req, const(flock_)* lock);
    ...
    size_t fuse_add_direntry(fuse_req_t req, char* buf, size_t bufsize,
            const(char)* name, const(stat_)* stbuf, off_t off);
	 ...
	 * @return zero for success, -errno for failure to send reply
	 */
    int fuse_reply_ioctl_retry(fuse_req_t req, const(iovec)* in_iov,
            size_t in_count, const(iovec)* out_iov, size_t out_count);
	 ...
	 * @return zero for success, -errno for failure
	 */
    int fuse_lowlevel_notify_store(fuse_chan* ch, fuse_ino_t ino, off_t offset,
	 ...
	 * @return zero for success, -errno for failure
	 */
    int fuse_lowlevel_notify_retrieve(fuse_chan* ch, fuse_ino_t ino, size_t size,
    ...
    fuse_session* fuse_lowlevel_new(fuse_args* args,
            const(fuse_lowlevel_ops)* op, size_t op_size, void* userdata);
    ...
    struct fuse_session_ops
    {
        /**
	    	 ...
	    	 */
        void function(void* data, const(char)* buf, size_t len, fuse_chan* ch) process;
        ...
        /**
	    	 ...
	    	 */
        void function(void* data, int val) exit;
    ...
    struct fuse_chan_ops
    {
        /**
	    	 ...
	    	 */
        int function(fuse_chan** chp, char* buf, size_t size) receive;
        ...
        /**
	    	 ...
	    	 */
        int function(fuse_chan* ch, const(iovec)[] iov, size_t count) send;
        ...
        /**
	    	 ...
	    	 * @param ch the channel
	    	 */
        void function(fuse_chan* ch) destroy;
    }
