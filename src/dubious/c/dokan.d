...
*/
module dubious.c.dokan;

public import dubious.c._fileinfo;
public import dubious.c._public;
...
enum DOKAN_VERSION = 100;
/** Minimum Dokan version (ver 1.0.0) accepted. */
enum DOKAN_MINIMUM_COMPATIBLE_VERSION = 100;
/** Maximum number of dokan instances.*/
enum DOKAN_MAX_INSTANCES = 32;
/** Driver file name including the DOKAN_MAJOR_API_VERSION */
enum DOKAN_DRIVER_NAME = "dokan"w ~ DOKAN_MAJOR_API_VERSION ~ ".sys"w;
/** Network provider name including the DOKAN_MAJOR_API_VERSION */
enum DOKAN_NP_NAME = "Dokan"w ~ DOKAN_MAJOR_API_VERSION;

enum DOKAN_OPTION : ULONG
{
...
alias _DOKAN_OPTIONS DOKAN_OPTIONS;
alias _DOKAN_OPTIONS* PDOKAN_OPTIONS;

/**
 * \struct DOKAN_FILE_INFO
 * \brief Dokan file information on the current operation.
 */
struct _DOKAN_FILE_INFO
{
    /**
...
alias _DOKAN_FILE_INFO DOKAN_FILE_INFO;
alias _DOKAN_FILE_INFO* PDOKAN_FILE_INFO;
 ...
 */
alias int delegate(PWIN32_FIND_DATAW, PDOKAN_FILE_INFO) PFillFindData;

/**
 * \brief FillFindStreamData Used to add an entry in FindStreams
 * \return 1 if buffer is full, otherwise 0 (currently it never returns 1)
 */
alias int delegate(PWIN32_FIND_STREAM_DATA, PDOKAN_FILE_INFO) PFillFindStreamData;
...
struct _DOKAN_OPERATIONS
{
  ...
  */
    NTSTATUS delegate(LPCWSTR FileName, PDOKAN_IO_SECURITY_CONTEXT SecurityContext,
            ACCESS_MASK DesiredAccess, ULONG FileAttributes,
            ULONG ShareAccess, ULONG CreateDisposition, ULONG CreateOptions,
            PDOKAN_FILE_INFO DokanFileInfo) ZwCreateFile;
  ...
  * \see DeleteDirectory
  */
    void delegate(LPCWSTR FileName, PDOKAN_FILE_INFO DokanFileInfo) Cleanup;
  ...
  * \param DokanFileInfo Information about the file or directory.
  */
    void delegate(LPCWSTR FileName, PDOKAN_FILE_INFO DokanFileInfo) CloseFile;
  ...
  * \see WriteFile
  */
    NTSTATUS delegate(LPCWSTR FileName, LPVOID Buffer, DWORD BufferLength,
            LPDWORD ReadLength, LONGLONG Offset, PDOKAN_FILE_INFO DokanFileInfo) ReadFile;
  ...
  * \see ReadFile
  */
    NTSTATUS delegate(LPCWSTR FileName, LPCVOID Buffer, DWORD NumberOfBytesToWrite,
            LPDWORD NumberOfBytesWritten, LONGLONG Offset, PDOKAN_FILE_INFO DokanFileInfo) WriteFile;
  ...
  * \return \c STATUS_SUCCESS on success or NTSTATUS appropriate to the request result.
  */
    NTSTATUS delegate(LPCWSTR FileName, PDOKAN_FILE_INFO DokanFileInfo) FlushFileBuffers;
  ...
  * \return \c STATUS_SUCCESS on success or NTSTATUS appropriate to the request result.
  */
    NTSTATUS delegate(LPCWSTR FileName, LPBY_HANDLE_FILE_INFORMATION Buffer,
            PDOKAN_FILE_INFO DokanFileInfo) GetFileInformation;
  ...
  */
    NTSTATUS delegate(LPCWSTR FileName, PFillFindData FillFindData, PDOKAN_FILE_INFO DokanFileInfo) FindFiles;
  ...
  * \see FindFiles
  */
    NTSTATUS delegate(LPCWSTR PathName, LPCWSTR SearchPattern,
            PFillFindData FillFindData, PDOKAN_FILE_INFO DokanFileInfo) FindFilesWithPattern;
  ...
  * \return \c STATUS_SUCCESS on success or NTSTATUS appropriate to the request result.
  */
    NTSTATUS delegate(LPCWSTR FileName, DWORD FileAttributes, PDOKAN_FILE_INFO DokanFileInfo) SetFileAttributes;
  ...
  * \return \c STATUS_SUCCESS on success or NTSTATUS appropriate to the request result.
  */
    NTSTATUS delegate(LPCWSTR FileName, const FILETIME* CreationTime,
            const FILETIME* LastAccessTime, const FILETIME* LastWriteTime,
            PDOKAN_FILE_INFO DokanFileInfo) SetFileTime;
    ...
    /**
	  ...
	  * \see Cleanup
	  */
    NTSTATUS delegate(LPCWSTR FileName, PDOKAN_FILE_INFO DokanFileInfo) DeleteFile;
    ...
    /**
	  ...
	  * \ref Cleanup
	  */
    NTSTATUS delegate(LPCWSTR FileName, PDOKAN_FILE_INFO DokanFileInfo) DeleteDirectory;
    ...
    /**
	  ...
	  * \return \c STATUS_SUCCESS on success or NTSTATUS appropriate to the request result.
	  */
    NTSTATUS delegate(LPCWSTR FileName, LPCWSTR NewFileName,
            BOOL ReplaceIfExisting, PDOKAN_FILE_INFO DokanFileInfo) MoveFile;
    ...
    /**
	  ...
	  * \return \c STATUS_SUCCESS on success or NTSTATUS appropriate to the request result.
	  */
    NTSTATUS delegate(LPCWSTR FileName, LONGLONG ByteOffset, PDOKAN_FILE_INFO DokanFileInfo) SetEndOfFile;
    ...
    /**
	  ...
	  * \return \c STATUS_SUCCESS on success or NTSTATUS appropriate to the request result.
	  */
    NTSTATUS delegate(LPCWSTR FileName, LONGLONG AllocSize, PDOKAN_FILE_INFO DokanFileInfo) SetAllocationSize;
    /**
	  ...
	  * \see UnlockFile
	  */
    NTSTATUS delegate(LPCWSTR FileName, LONGLONG ByteOffset, LONGLONG Length,
            PDOKAN_FILE_INFO DokanFileInfo) LockFile;
    ...
    /**
	  ...
	  */
    NTSTATUS delegate(LPCWSTR FileName, LONGLONG ByteOffset, LONGLONG Length,
            PDOKAN_FILE_INFO DokanFileInfo) UnlockFile;
    ...
    /**
	  ...
	  */
    NTSTATUS delegate(PULONGLONG FreeBytesAvailable, PULONGLONG TotalNumberOfBytes,
            PULONGLONG TotalNumberOfFreeBytes, PDOKAN_FILE_INFO DokanFileInfo) GetDiskFreeSpace;
    ...
    /**
	  ...
	  */
    NTSTATUS delegate(LPWSTR VolumeNameBuffer, DWORD VolumeNameSize,
            LPDWORD VolumeSerialNumber, LPDWORD MaximumComponentLength,
            LPDWORD FileSystemFlags, LPWSTR FileSystemNameBuffer,
            DWORD FileSystemNameSize, PDOKAN_FILE_INFO DokanFileInfo) GetVolumeInformation;
    ...
    /**
	  ...
	  * \see Unmounted
	  */
    NTSTATUS delegate(PDOKAN_FILE_INFO DokanFileInfo) Mounted;
    ...
    /**
	  ...
	  * \see Unmounted
	  */
    NTSTATUS delegate(PDOKAN_FILE_INFO DokanFileInfo) Unmounted;
    ...
    /**
	  ...
	  */
    NTSTATUS delegate(LPCWSTR FileName, PSECURITY_INFORMATION SecurityInformation,
            PSECURITY_DESCRIPTOR SecurityDescriptor, ULONG BufferLength,
            PULONG LengthNeeded, PDOKAN_FILE_INFO DokanFileInfo) GetFileSecurity;
    ...
    NTSTATUS delegate(LPCWSTR FileName, PSECURITY_INFORMATION SecurityInformation,
            PSECURITY_DESCRIPTOR SecurityDescriptor, ULONG BufferLength,
            PDOKAN_FILE_INFO DokanFileInfo) SetFileSecurity;
    ...
    /**
	  ...
	  * \return \c STATUS_SUCCESS on success or NTSTATUS appropriate to the request result.
	  */
    NTSTATUS delegate(LPCWSTR FileName, PFillFindStreamData FillFindStreamData,
            PDOKAN_FILE_INFO DokanFileInfo) FindStreams;

}

alias _DOKAN_OPERATIONS DOKAN_OPERATIONS;
alias _DOKAN_OPERATIONS* PDOKAN_OPERATIONS;

/**
* \struct DOKAN_CONTROL
* \brief Dokan Control
*/
struct _DOKAN_CONTROL
{
    /** File System Type */
    ULONG Type;
    /** Mount point. Can be "M:\" (drive letter) or "C:\mount\dokan" (path in NTFS) */
    WCHAR[MAX_PATH] MountPoint;
...
alias _DOKAN_CONTROL DOKAN_CONTROL;
alias _DOKAN_CONTROL* PDOKAN_CONTROL;

enum DokanMainResult : int
{
    /** Dokan mount succeed. */
    DOKAN_SUCCESS = 0,
    /** Dokan mount error. */
 ...
 */
export DokanMainResult DokanMain(PDOKAN_OPTIONS DokanOptions, PDOKAN_OPERATIONS DokanOperations);
 ...
 */
export BOOL DokanUnmount(WCHAR DriveLetter);
 ...
 * \return \c TRUE if device was unmount or False in case of failure or device not found.
 */
export BOOL DokanRemoveMountPoint(LPCWSTR MountPoint);
 ...
 */
export BOOL DokanRemoveMountPointEx(LPCWSTR MountPoint, BOOL Safe);
 ...
 */
export BOOL DokanIsNameInExpression(LPCWSTR Expression, LPCWSTR Name, BOOL IgnoreCase);
 ...
 */
export ULONG DokanDriverVersion();
 ...
 */
export BOOL DokanResetTimeout(ULONG Timeout, PDOKAN_FILE_INFO DokanFileInfo);
 ...
 */
export HANDLE DokanOpenRequestorToken(PDOKAN_FILE_INFO DokanFileInfo);
 ...
 */
export BOOL DokanGetMountPointList(PDOKAN_CONTROL list, ULONG length, BOOL uncOnly, PULONG nbRead);
 ...
 */
export void DokanMapKernelToUserCreateFileFlags(ULONG FileAttributes, ULONG CreateOptions,
        ULONG CreateDisposition, DWORD* outFileAttributesAndFlags, DWORD* outCreationDisposition);
...
/**
  ...
  */
export ACCESS_MASK DokanMapStandardToGenericAccess(ACCESS_MASK DesiredAccess);
 ...
 */
export NTSTATUS DokanNtStatusFromWin32(DWORD Error);
